...
config.bind('<Space>mt', ':open monkeytype.com')
config.bind('<Space>ky', ':open keybr.com')
config.bind('<Space>tr', ':open typeracer.com')
config.bind('<Space>cf', ':open codeforces.com')
config.bind('<Space>re', ':open reddit.com')
config.bind('<Space>gh', ':open github.com/Xaerru')
config.bind('<Space>yt', ':open youtube.com')
...
config.bind('<Space>l', ':open https://www.lua.org/manual/5.4/manual.html#4')
config.bind('<Space>c', ':open https://craftinginterpreters.com/contents.html')
config.bind('<Space>s', ':open https://sr.ht')
